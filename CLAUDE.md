...
This project is indexed by GitNexus as **AirVibe_Waveform_Manager** (1047 symbols, 2000 relationships, 87 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/AirVibe_Waveform_Manager/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/AirVibe_Waveform_Manager/context` | Codebase overview, check index freshness |
| `gitnexus://repo/AirVibe_Waveform_Manager/clusters` | All functional areas |
| `gitnexus://repo/AirVibe_Waveform_Manager/processes` | All execution flows |
| `gitnexus://repo/AirVibe_Waveform_Manager/process/{name}` | Step-by-step execution trace |
